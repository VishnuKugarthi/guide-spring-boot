...
### Log when server is turned off.
```
C[INFO] [AUDIT   ] CWWKT0017I: Web application removed (default_host): http://192.168.1.6:9080/
...
[INFO] [AUDIT   ] CWWKT0017I: Web application removed (default_host): https://192.168.1.6:9443/ibm/saml20/
[INFO] [AUDIT   ] CWWKE0055I: Server shutdown requested on Monday, 6 February, 2023 at 4:57 PM. The server defaultServer is shutting down.
```